...
namespace coolsynth::midi
{
    namespace
    {
        ...
        constexpr std::array<Minilab3ControlDefinition, 13> verifiedControls {{
            ...
            { "knob2", "Knob 2", Minilab3ControlCategory::knob, "filter cutoff", Minilab3Disposition::requiredForPhase7,
              { VerifiedMidiMessageKind::controlChange, 1, {71, 71}, {0, 127}, Minilab3ValueMode::absolute, false, false }, "Timbre" },
            { "knob3", "Knob 3", Minilab3ControlCategory::knob, "filter resonance", Minilab3Disposition::requiredForPhase7,
              { VerifiedMidiMessageKind::controlChange, 1, {76, 76}, {0, 127}, Minilab3ValueMode::absolute, false, false }, "Variation" },
            { "knob4", "Knob 4", Minilab3ControlCategory::knob, "amp attack", Minilab3Disposition::requiredForPhase7,
              { VerifiedMidiMessageKind::controlChange, 1, {77, 77}, {0, 127}, Minilab3ValueMode::absolute, false, false }, "Movement" },
            { "knob5", "Knob 5", Minilab3ControlCategory::knob, "amp decay", Minilab3Disposition::requiredForPhase7,
              { VerifiedMidiMessageKind::controlChange, 1, {93, 93}, {0, 127}, Minilab3ValueMode::absolute, false, false }, "FX A" },
            { "knob6", "Knob 6", Minilab3ControlCategory::knob, "amp sustain", Minilab3Disposition::requiredForPhase7,
