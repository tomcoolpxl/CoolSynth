...
namespace coolsynth::midi
{
    namespace
    {
        ...
        constexpr std::array<Minilab3ControlDefinition, 14> verifiedControls {{
            ...
            { "knob3", "Knob 3", Minilab3ControlCategory::knob, "delay time", Minilab3Disposition::requiredForPhase7,
              { VerifiedMidiMessageKind::controlChange, 1, {76, 76}, {0, 127}, Minilab3ValueMode::absolute, false, false }, "Variation" },
            { "knob4", "Knob 4", Minilab3ControlCategory::knob, "delay feedback", Minilab3Disposition::requiredForPhase7,
            ...
            { "fader2", "Fader 2", Minilab3ControlCategory::fader, "delay mix", Minilab3Disposition::requiredForPhase7,
